...
export function CrosswordGrid({
  ...
  return (
    <div
      className="w-full min-w-0 max-w-full lg:max-w-[var(--board-cap)]"
      style={
        {
          "--board-cap": `${puzzle.size * 36 + puzzle.size + 1}px`,
    ...
    >
      ...
      >
        {puzzle.grid.map((solution, i) => {
          ...
          const col = i % puzzle.size;
          if (solution === null) {
            return <div key={i} className="min-w-0 bg-[var(--ink)]" aria-hidden />;
          }
